...
class LoggerBuilder:
		...
		@throws(TypeError)
		def add_colored_console_appender(self, formatter: Optional["BaseFormatter"] = None, color: Optional["ConsoleColor"] = None):
		...
		@throws(TypeError)
		def add_file_appender(self, file_path: str, formatter: Optional["BaseFormatter"] = None):
