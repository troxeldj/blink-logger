...
class TestKeywordFilter:
    ...
    def test_keyword_filter_initialization_invalid_type(self):
        ...
        with pytest.raises(ValueError, match="Keywords must be a string or a list of strings"):
...
class TestLevelFilter:
    ...
    def test_level_filter_debug_level_allows_all(self):
        ...
        for level in [LoggingLevel.DEBUG, LoggingLevel.INFO, LoggingLevel.WARNING, 
    ...
    def test_level_filter_critical_level_most_restrictive(self):
        ...
        for level in [LoggingLevel.DEBUG, LoggingLevel.INFO, LoggingLevel.WARNING, LoggingLevel.ERROR]:
            record = LogRecord(level, "Test message")
            assert filter_obj.should_log(record) is False
...
class TestFilterIntegration:
    ...
    def test_composite_appender_with_filters(self):
        ...
        appender1 = ConsoleAppender(formatter=SimpleFormatter(), filters=[keyword_filter])
...
class TestFilterPerformance:
    ...
    def test_keyword_filter_large_keyword_list(self):
        ...
        record1 = LogRecord(LoggingLevel.INFO, "This contains keyword_500 in the message")
        assert filter_obj.should_log(record1) is True
