...
class Logger:
  ...
  def __init__(
    self,
    name: str,
    level: Union[LoggingLevel, None] = None,
  ...
  @throws(TypeError)
  def _verify_log(
    self, level: LoggingLevel, message: str, metadata: Optional[dict] = {}
  ):
    ...
    if not all(
      isinstance(appender, self._get_base_appender_class())
  ...
  def __eq__(self, other):
    ...
    return (
      ...
      and self.appenders == other.appenders
    )
